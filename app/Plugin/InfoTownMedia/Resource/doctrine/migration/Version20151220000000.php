 ...
 */
class Version20151220000000 extends AbstractMigration
{
    ...
    {
        $schema->dropTable('plg_infotown_media_config');
    }

    /**
     * Create plg_link_wordpress table used by InfoTownMedia only plugin install.
     * @param Schema $schema
     */
    protected function createConfig(Schema $schema)
    {
        $table = $schema->createTable('plg_infotown_media_config');
        $table->addColumn(
            'id',
            'integer',
            [
